            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ url('/admin') }}">Masuk/Daftar</a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">Media penjembatan antar mandor dengan kuli bangunan</p>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">Fitur Utama Nguli.id</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 text-center">
                                    <div class="mt-5">
                                        ...
                                        <h3 class="h4 mb-2 text-light">Ready to Publish</h3>
                        ...
                        <p class="text-white-50 mb-4">Kuli dapat mendaftar dan menunggu sampai adanya Rekrutmen dari Mandor, atau Kuli dapat mendaftarkan diri ke sebuah sayembara proyek.</p>
